export function AzureAiIcon() {
  return (
    <svg
      ...
      role="img"
      aria-label="Azure AI Icon"
    >
      <title>Azure AI Icon</title>
      <path
        clipRule="evenodd"
